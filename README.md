...
This repo reflects **the current, working state of the project**, not future placeholders.
...
- Documentation lives **inside the files** (Dockerfiles, scripts), not just READMEs
...
This repository is **actively evolving** and reflects only completed, runnable chapters.
